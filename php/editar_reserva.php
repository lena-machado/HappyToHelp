...
<?php
  ...
  if ($_SESSION['userName'] == null){
    ...
    $query_user = "SELECT * FROM museunadirafonso WHERE id_marcacao='$id_marcacao'";
  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-4 col-lg-4 col-xl-4 offset-xl-1">
      	...
      	Editar Reserva</p>
        <form action='./editar_reserva_bd.php' method="post">
          ...
          <div class="form-outline mb-3">
            <input type="text" id="form3Example4" class="form-control form-control-lg" style="background-color: rgb(75, 74, 74); color:beige"
              placeholder="Manhã ou Tarde" name="periodo" value="<?php echo $row['periodo'] ?>"/>
          </div>
          <div class="form-outline mb-3">
            <input type="date" id="form3Example4" class="form-control form-control-lg" style="background-color: rgb(75, 74, 74); color:beige"
              placeholder="Selecione a data" name="data" value="<?php echo $row['data'] ?>"/>
          </div>
          <div class="form-outline mb-3">
            <input type="number" id="form3Example4" class="form-control form-control-lg" style="background-color: rgb(75, 74, 74); color:beige"
              placeholder="Insira o num de Adultos" name="num_adultos" value="<?php echo $row['num_adultos'] ?>"/>
          </div>
          <div class="form-outline mb-3">
            <input type="number" id="form3Example4" class="form-control form-control-lg" style="background-color: rgb(75, 74, 74); color:beige"
              placeholder="Insira o num de Crianças" name="num_criancas" value="<?php echo $row['num_criancas'] ?>"/>
          </div>
