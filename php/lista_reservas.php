...
<?php
  ...
  if ($_SESSION['userName'] == null){
    ...
    # Criar a query de listagem de reservas
    $user=$_SESSION['userName'];
    $query_user = "SELECT * FROM museunadirafonso WHERE username='$user';";

    # realiza a query da listagem de todas as reservas
        ...
        <table align='center' class='table table-lightdark table-striped table-hover table-responsive' style="width: 100%; font-size:medium;">
            <tr class='bg-primary'>
                <thead style='background-color: rgb(75, 74, 74); color: beige;'>
                    ...
                    <th style="width: 5%;">Num Adultos</th>
                    <th style="width: 5%;">Num Crianças</th>
...
<?php
            while ($row = mysqli_fetch_array( $result_query_select_all )) {
                ...
                <tr>
                    ...
                    <td>".$row['periodo']."</td>
                    <td>".$row['data']."</td>
                    <td>".$row['num_adultos']."</td>
                    <td>".$row['num_criancas']."</td>
                    <td>".$row['obs']."</td>
